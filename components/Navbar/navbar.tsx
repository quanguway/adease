...
const NavTool = ({data}:{data:any}) => {
  return (
    <ul className="flex items-center flex-row md:mt-0 md:text-sm md:font-medium sm:flex-col sm:items-start sm:text-xl sm:w-full sm:p-0">
	...
	return (
		<nav className="px-2 sm:px-4 py-2.5 overflow-hidden">
      <div className="flex items-center justify-between md:justify-around sm:justify-between">
        <a href="#" className="flex items-center">
          <div className="w-[63px] h-[63px] md:w-[42px] md:h-[42px] relative">
